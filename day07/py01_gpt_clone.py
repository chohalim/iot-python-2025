...
# 6. 제미나이 API용 구성
genai.configure(api_key='AIzaSyBPuAhm1CP6pMLsk9UioATjQVKTbbrq8dE') # AIzaSyBPuAhm1CP6pMLsk9UioATjQVKTbbrq8dE
...
# 2. UI화면 구성
inputFrame = Frame(root, width=730, height=30, bg='#EFEFEF') # '#EFEFEF' 연한회색
